...
<head>
    ...
    <link data-jsfiddle="common" rel="stylesheet" media="screen"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/handsontable/handsontable.css">
    <link data-jsfiddle="common" rel="stylesheet" media="screen"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/handsontable/pikaday.css">
    <link data-jsfiddle="common" rel="stylesheet" media="screen"
    ...
    <script data-jsfiddle="common"
            src="<?php echo Yii::app()->request->baseUrl; ?>/js/handsontable/pikaday/pikaday.js"></script>
    <script data-jsfiddle="common"
            src="<?php echo Yii::app()->request->baseUrl; ?>/js/handsontable/moment/moment.js"></script>
    <script data-jsfiddle="common"
            src="<?php echo Yii::app()->request->baseUrl; ?>/js/handsontable/zeroclipboard/ZeroClipboard.js"></script>
    <script data-jsfiddle="common"
            src="<?php echo Yii::app()->request->baseUrl; ?>/js/handsontable/handsontable.js"></script>
    <script data-jsfiddle="common"
            src="<?php echo Yii::app()->request->baseUrl; ?>/js/bootstrap-datepicker.js"></script>
...
//                    array('label'=>'Tin nhắn mẫu', 'url'=>array('/templates'),'visible'=>!Yii::app()->user->isGuest),
                array('label' => 'Danh bạ', 'url' => array('/contacts'), 'visible' => !Yii::app()->user->isGuest,
                    'items' => array(
                        ...
                        array('label' => 'Nhận xét', 'url' => array('/comment')),
...
//                                array('label'=>'Tải báo cáo quảng cáo','url'=>array('/upload-report'),'visible'=>!Yii::app()->user->isGuest),
                ...
                array('label' => 'Quản lý tài khoản', 'url' => '/Members', 'visible' => !Yii::app()->user->isGuest,
                    'items' => array(
                        array('label' => 'Quản lý thành viên', 'url' => array('/Members'),
                            'visible' => (!Yii::app()->user->isGuest && Members::model()->getRoleSystem() != Members::THANHVIEN_KHACHHANGDAILY && Members::model()->getRoleSystem() != Members::THANHVIEN_KHACHHANGDAILYCAPDUOI && Members::model()->getRoleSystem() != Members::THANHVIEN_KHACHHANGADMIN),
                        ),
