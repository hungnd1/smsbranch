...
<div class="col-xs-12 col-sm-9">
    <h1 class="the-article-title-bv"><span><?php echo $title;?></span></h1>
        <?php  
    ...
    <div class="col-sm-6 col-md-4" >
                  <div class="thumbnail" >
                    <?php 
                        if($image_dv !=""){
                            echo '<img style="width:200px;height:242px" src="'.YII::app()->baseUrl.'/tb-admin/uploads/'.$image_dv.'" width="1070" alt="side1">';

                        }
                        else
                        {
                            echo '<img style="width:200px;height:242px"  src="'.YII::app()->baseUrl.'/images/baove/Capture.PNG" width="1070" alt="side1">';
                        }
                    ?>
