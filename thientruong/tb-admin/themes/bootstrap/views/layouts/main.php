...
<!--            <script src="<?php echo Yii::app()->baseUrl; ?>/js/sidebar/jquery-2.1.4.js"></script>-->
            <script src="<?php echo Yii::app()->baseUrl; ?>/js/sidebar/jquery-ui.js"></script>
            <script src="<?php echo Yii::app()->baseUrl; ?>/js/sidebar/bootstrap.min.js"></script>
			...
			<ul class="cd-top-nav">
				...
				<li class="has-children account">
					<a href="#0">
						...
						<?php echo Members::model()->getName(YII::app()->user->id);?>
					</a>
