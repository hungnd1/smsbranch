...
class ContactsController extends Controller
{
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionUpdateStatus(){
            if(isset($_POST['contact_id']) && $_POST['contact_id']!="" && isset($_POST['contact_status']))
            {
                $contact = $this->loadModel($_POST['contact_id']);
                $contact->contact_status=$_POST['contact_status'];
                if($contact->save())
                    echo '{"status":"success"}';
                else
                    echo '{"status":"fail"}';
