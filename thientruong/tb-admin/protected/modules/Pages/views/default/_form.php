...
//                            ));
	...
	<div class="control-group">
		<?php echo $form->labelEx($model,'page_image',array('class'=>"control-label")); ?>
            <div class="controls-row">
		<?php echo $form->fileField($model,'page_image'); ?>
            </div>
	</div>
	...
	<div class="row" id="page-content-en" style="display: none;margin-top: 10px;">
		<?php echo $form->labelEx($model,'page_contenten'); ?>
                <?php 
                        $this->widget('ext.ckeditor.CKEditorWidget',array(
                                    "model" => $model,                 # Data-Model
                                    "attribute"=> 'page_contenten',          # Attribute in the Data-Model
                                    "defaultValue" => $model->page_contenten,     # Optional
