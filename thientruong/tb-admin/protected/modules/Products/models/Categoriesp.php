 ...
 * @property integer $categories_type
 * @property string $cate_images_1
 * @property string $cate_titleen
 */
class Categoriesp extends CActiveRecord
{
    static public $type = array('1'=>'Menu','2'=>'Hãng xe');
	...
	public function rules()
	{
		...
		return array(
			...
			array('cate_title, cate_image, cate_sublink,cate_images_1,cate_titleen', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cate_id, cate_title, cate_content, cate_image, cate_sublink, cate_createdate, cate_status, cate_parent,cate_titleen, cate_order, categories_type,cate_images_1', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'cate_content' => Yii::t('lang','Mô tả'),
			'cate_image' => Yii::t('lang','Ảnh silde'),
			...
			'cate_order' => Yii::t('lang','Thứ tự'),
                        'categories_type' => YII::t('lang','Loại'),
                        'cate_images_1'=>YII::t('lang','Ảnh hãng xe'),
                        'cate_titleen'=>'Tiêu đề tiếng anh'
		);
	}
