...
class Comment extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
                    'post'=>array(self::BELONGS_TO, 'Post', 'comment_entry_id'),
                    'member'=>array(self::BELONGS_TO, 'Members', 'comment_memberid'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('comment_memberid',$this->comment_memberid);
                ...
                $criteria->order = 'comment_status DESC';
	...
	public static function model($className=__CLASS__)
	{
        ...
        public static function getStatusComment(){
            return array(
                ...
                self::COMMENT_APPROVED => self::COMMENT_LABEL_UN_APPROVED,
