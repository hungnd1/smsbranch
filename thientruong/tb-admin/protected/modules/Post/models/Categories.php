...
class Categories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cate_id, cate_title, cate_summany, cate_sublink, cate_order, cate_status, cate_parent,cate_image', 'safe', 'on'=>'search'),
		);
	}
