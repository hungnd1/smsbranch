...
class DefaultController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Members']))
		{
                        ...
                        $model->pr_member_parent=YII::app()->user->id;
                        if($model->save())
                        {
	...
	public function actionDelete()
	{
            ...
            {
                $result['error'] = "Không được phép xóa.";
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['Members']))
			$model->attributes=$_GET['Members'];
                ...
                $modelAll=new Members('search');
                $modelAll->unsetAttributes();  // clear any default values
                if(isset($_GET['Members']))
                        $modelAll->attributes=$_GET['Members'];
                $modelAll->pr_member_parent = YII::app()->user->id;
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionChangePassword($id)
        {
            ...
            if(isset($_POST['Member']))
            {
                ...
                if($is_check)
                {
                    ...
                    $model->pr_pass = $Member_arr['pr_member_new_password'];
                    if($model->save())
        ...
        public function actionUpdateInformation($id)
        {
            ...
            $this->render('_form_update_information', array(
                            'model'=>$model,
