 ...
 * @property string $pr_member_copyright
 * @property string $is_domain
 */
class MemberProfile extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pr_member_id,is_domain', 'numerical', 'integerOnly'=>true),
			...
			array('pr_member_profile_address, pr_member_profile_images', 'length', 'max'=>255),
                        array('pr_member_copyright', 'length'),
                        
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pr_primary_key, pr_member_id, pr_member_profile_surname, pr_member_profile_given_name, pr_member_profile_display_name, pr_member_profile_phone, pr_member_profile_address, pr_member_profile_images, pr_member_profile_date, pr_member_copyright,is_domain', 'safe', 'on'=>'search'),
		);
	}
