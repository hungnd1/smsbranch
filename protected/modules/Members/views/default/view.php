...
$canUpdate = false;
if(YII::app()->user->id == $model->pr_primary_key || Members::model()->getManagerSystem())
    $canUpdate =true;
        ...
        <?php $this->widget('bootstrap.widgets.TbDetailView', array(
                ...
                'attributes'=>array(
                        array(
                            'name'=>'Tài khoản',
                            'type'=>'raw',
                            'value'=>$model->pr_username,
                        ),
                        array(
                            'name'=>'Mật khẩu',
                            'type'=>'raw',
                            'value'=>$model->pr_pass,
                            'visible'=>(Members::model()->getRoleSystem()==Members::ADMIN)
                        ),
                        array(
                            'name'=>'Họ tên',
                            'type'=>'raw',
...
//                        'name'=>'Bản quyền',
//                        'type'=>'raw',
//                        'value'=>  nl2br($model->memberProfile->pr_member_copyright)
//                    ),
                    array(
