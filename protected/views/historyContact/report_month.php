...
<?php $this->renderPartial('_search_report_month'); ?>
...
<script type="text/javascript">
    ...
    function exportExel(){
        ...
        var month = $('#HistoryContact_history_monthdate').val();
        var createBy = $('#HistoryContact_history_createby').val();
        var telecom = getIDSelectInput();
        var url = '<?php echo $this->createUrl('ExportExcelFlowMonth'); ?>';
        window.open(url+'/brandname/'+brandname+'/type/'+type+'/status/'+status+'/month/'+month+'/telecoms/'+telecom+'/createBy/'+createBy);
    }
