...
{	
     ...
     * @return type
     */
    public static function removesign($str,$pace="-")
    {
    ...
    public static function listVariableContact()
    {
        $option_type_arr=array();
        $option_type_arr[0]['name']='$ho$';
        $option_type_arr[0]['description']='Họ';
        $option_type_arr[1]['name']='$ten$';
        $option_type_arr[1]['description']='Tên';
        $option_type_arr[2]['name']='$tuoi$';
        $option_type_arr[2]['description']='Tuổi';
        $option_type_arr[3]['name']='$email$';
        $option_type_arr[3]['description']='Email';
        $option_type_arr[4]['name']='$dienthoai$';
        $option_type_arr[4]['description']='Số điện thoại';
        $option_type_arr[5]['name']='$gioitinh$';
        $option_type_arr[5]['description']='Giới tính';
        $option_type_arr[6]['name']='$diachi$';
        $option_type_arr[6]['description']='Địa chỉ';
        $option_type_arr[7]['name']='$thanhpho$';
        $option_type_arr[7]['description']='Thành phố';
        $option_type_arr[8]['name']='$congty$';
        $option_type_arr[8]['description']='Công ty';
        $option_type_arr[9]['name']='$ngaysinh$';
        $option_type_arr[9]['description']='Ngày sinh';
     ...
     * @return type
     */
    public static function convert84($number)
    {
        $number = trim($number);
        $index_1 = substr($number, 0,1);
        if($index_1 == 0)
        {
            $number = substr($number, 1);
        }
        $number_str2 = substr($number,0,2);
        if($number_str2!=84)
            $number = "84".$number;
        return $number;
    }
